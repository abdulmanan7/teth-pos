  ...
  return (
    <>
      <div className="flex flex-col h-screen bg-slate-900">
        {/* Header */}
        <header className="bg-slate-700 border-b border-slate-600 px-6 py-3 shadow-lg">
          <div className="flex items-center justify-between gap-4">
            {/* Logo & Title */}
            <div className="flex items-center gap-3 min-w-0">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120 120" fill="none" className="w-10 h-10 flex-shrink-0">
                <circle cx="60" cy="60" r="58" fill="#1e293b" stroke="#3b82f6" strokeWidth="2"/>
                <defs>
                ...
                <path d="M 30 35 L 70 35 L 70 45 L 55 45 L 55 85 L 45 85 L 45 45 L 30 45 Z" fill="url(#logoGradient)"/>
                <path d="M 75 50 Q 75 45 80 45 Q 85 45 85 50 L 85 70 Q 85 75 82.5 77.5 Q 80 80 77.5 77.5 Q 75 75 75 70 Z" fill="#06b6d4" opacity="0.8"/>
                <circle cx="35" cy="30" r="2" fill="#3b82f6"/>
                <circle cx="65" cy="30" r="2" fill="#06b6d4"/>
                <line x1="30" y1="90" x2="90" y2="90" stroke="url(#logoGradient)" strokeWidth="3" strokeLinecap="round"/>
              </svg>
              <div className="min-w-0">
                <h1 className="text-lg font-bold text-white truncate">Teth POS</h1>
              </div>
            </div>
            ...
            <div className="hidden sm:flex items-center gap-4 text-xs text-blue-100">
              <div className="text-center">
                ...
                <div className="text-blue-200">{new Date().toLocaleTimeString("en-US", { hour: "2-digit", minute: "2-digit" })}</div>
              </div>
            </div>
        ...
        <main className="flex-1 overflow-auto">
          <div className="p-6">
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 h-full">
              ...
              <div className="hidden lg:block space-y-4">
                ...
                <div className="bg-slate-800 rounded-lg border border-slate-700 p-4">
                  <div className="text-center mb-4">
                    ...
                    {selectedCustomer !== "Walk-in" && (
                      <p className="text-xs text-slate-400 mt-1">Loyalty program</p>
                    )}
                  </div>
                  ...
                  {selectedCustomer !== "Walk-in" && (
                    <div className="space-y-3 text-xs">
                      ...
                      <div className="flex justify-between p-2 bg-slate-700/50 rounded">
                        ...
                        <span className="font-bold text-white">4200</span>
                      </div>
                      <div className="flex justify-between p-2 bg-slate-700/50 rounded">
                ...
                <div className="mb-6 grid grid-cols-3 gap-2">
                  <button
                    ...
                    className="bg-blue-600 hover:bg-blue-700 text-white rounded-lg p-3 font-medium text-sm transition-all flex flex-col items-center gap-1"
                  >
                  ...
                  <button
                    ...
                    className="bg-purple-600 hover:bg-purple-700 text-white rounded-lg p-3 font-medium text-sm transition-all flex flex-col items-center gap-1"
                  >
                  ...
                  <button
                    ...
                    className="bg-cyan-600 hover:bg-cyan-700 text-white rounded-lg p-3 font-medium text-sm transition-all flex flex-col items-center gap-1"
                  >
                  ...
                  <button
                    ...
                    className="bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg p-3 font-medium text-sm transition-all flex flex-col items-center gap-1"
                  >
                  ...
                  <button
                    ...
                    className="bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg p-3 font-medium text-sm transition-all flex flex-col items-center gap-1"
                  >
                  ...
                  <button
                    ...
                    className="bg-orange-600 hover:bg-orange-700 text-white rounded-lg p-3 font-medium text-sm transition-all flex flex-col items-center gap-1 relative"
                  >
                ...
                <div className="bg-slate-800 rounded-lg border border-slate-700 p-4">
                  <h3 className="text-sm font-semibold text-white mb-3">📋 Recent Orders ({recentOrders.length})</h3>
                  <div className="space-y-2">
                    {recentOrders.length === 0 ? (
                      ...
                      recentOrders.map((order: any, index: number) => {
                        ...
                        return (
                          <div key={order._id} className="bg-slate-700/50 p-2 rounded border border-slate-600 hover:border-slate-500 cursor-pointer transition-colors">
                    ...
                    filteredProducts.map((product) => {
                      ...
                      return (
                        <button
                          ...
                          className={`bg-slate-700 border border-slate-600 rounded-lg p-2 transition-all group relative ${
                            isClicking
                              ? "scale-98"
                              : "hover:bg-slate-600"
                          }`}
                        >
                          <h4 className="text-xs font-semibold text-white text-left line-clamp-2 mb-1">
                            {product.name}
                          </h4>
                          ...
                          {/* Stock Display */}
                          <div className="text-xs text-slate-300 mt-1 text-left">
              ...
              <div className="bg-slate-800 rounded-lg border border-slate-700 p-6 flex flex-col sticky top-6 h-fit max-h-[calc(100vh-120px)]">
                ...
                <div className="flex-1 overflow-auto mb-4 space-y-2 min-h-0">
                  {cartItems.length === 0 ? (
                    ...
                    cartItems.map((item) => (
                      <div key={item.productId} className="bg-slate-700/30 p-2 rounded border border-slate-600">
                        <div className="flex justify-between items-center mb-1">
                          <h4 className="font-semibold text-white text-xs flex-1 line-clamp-1">
                            {item.name}
                          </h4>
                          <button
                        ...
                        <div className="flex justify-between items-center text-xs">
                          ...
                          <div className="flex items-center gap-0.5">
                            <button
                              ...
                              className="px-1.5 py-0.5 bg-slate-600 hover:bg-slate-500 rounded text-white font-bold text-xs"
                            >
                              -
                            </button>
                            <input
                              ...
                              className="w-8 text-center bg-slate-600 text-white rounded px-0.5 py-0.5 text-xs"
                              min="1"
                            />
                            <button
                              type="button"
                ...
                <div className="border-t border-slate-600 pt-4 mb-4">
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      className="flex-1 bg-slate-700 border border-slate-600 text-white rounded px-2 py-1 text-sm focus:outline-none focus:border-blue-500"
                      placeholder="0"
                    />
                    <span className="text-slate-400 text-sm font-semibold py-1">%</span>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  <div className="grid grid-cols-3 gap-2 mb-2">
                    <button
                      ...
                      className="px-3 py-2 bg-slate-600 hover:bg-slate-500 text-white rounded font-semibold text-sm transition-colors flex flex-col items-center gap-1"
                    >
                    ...
                    <button
                      ...
                      className="px-3 py-2 bg-red-600 hover:bg-red-700 text-white rounded font-semibold text-sm transition-colors flex flex-col items-center gap-1"
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5">
                    ...
                    <button
                      ...
                      className="px-3 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded font-semibold text-sm transition-colors disabled:opacity-50 flex flex-col items-center gap-1"
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5">
                  ...
                  <button
                    ...
                    className="w-full px-4 py-3 bg-lime-500 hover:bg-lime-600 text-slate-900 rounded font-bold text-lg disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center gap-2"
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5">
      ...
      {/* Modals */}
      {activeModal === "products" && <ProductsModal onClose={closeModal} />}
      {activeModal === "customers" && <CustomersModal onClose={closeModal} />}
      {activeModal === "orders" && <OrdersModal onClose={closeModal} />}
      {activeModal === "history" && <OrderHistoryModal onClose={closeModal} />}
      {activeModal === "sales" && <SalesReportModal onClose={closeModal} />}
      {activeModal === "resume" && (
        <ResumeOrderModal
      ...
      {activeModal === "admin" && <AdminModal onClose={closeModal} userRole={currentStaff?.role} />}
      {activeModal === "returns" && <ReturnsModal onClose={closeModal} />}
