...
export async function createServer() {
  ...
  app.get(
    "/api/inventory/lot-numbers/product/:productId",
    async (req, res, next) => {
      const { getLotNumbersByProduct } = await import(
        "./routes/inventory/lot-numbers"
      );
  ...
  app.get("/api/inventory/reorder-rules", async (req, res, next) => {
    const { getAllReorderRules } = await import(
      "./routes/inventory/reorder-rules"
    );
    return getAllReorderRules(req, res, next);
  });

  app.get(
    "/api/inventory/reorder-rules/check/triggers",
    async (req, res, next) => {
      const { checkReorderTriggers } = await import(
        "./routes/inventory/reorder-rules"
      );
  ...
  app.post("/api/inventory/reorder-rules", async (req, res, next) => {
    const { createReorderRule } = await import(
      "./routes/inventory/reorder-rules"
    );
  ...
  app.put("/api/inventory/reorder-rules/:id", async (req, res, next) => {
    const { updateReorderRule } = await import(
      "./routes/inventory/reorder-rules"
    );
  ...
  app.delete("/api/inventory/reorder-rules/:id", async (req, res, next) => {
    const { deleteReorderRule } = await import(
      "./routes/inventory/reorder-rules"
    );
  ...
  app.get("/api/inventory/serial-numbers", async (req, res, next) => {
    const { getAllSerialNumbers } = await import(
      "./routes/inventory/serial-numbers"
    );
    return getAllSerialNumbers(req, res, next);
  });

  app.get(
    "/api/inventory/serial-numbers/status/:status",
    async (req, res, next) => {
      const { getSerialNumbersByStatus } = await import(
        "./routes/inventory/serial-numbers"
      );
  ...
  app.get(
    "/api/inventory/serial-numbers/product/:productId",
    async (req, res, next) => {
      const { getSerialNumbersByProduct } = await import(
        "./routes/inventory/serial-numbers"
      );
  ...
  app.get(
    "/api/inventory/serial-numbers/lot/:lotId",
    async (req, res, next) => {
      const { getSerialNumbersByLot } = await import(
        "./routes/inventory/serial-numbers"
      );
  ...
  app.get("/api/inventory/serial-numbers/:id", async (req, res, next) => {
    const { getSerialNumberById } = await import(
      "./routes/inventory/serial-numbers"
    );
  ...
  app.post("/api/inventory/serial-numbers", async (req, res, next) => {
    const { createSerialNumber } = await import(
      "./routes/inventory/serial-numbers"
    );
  ...
  app.post("/api/inventory/serial-numbers/bulk", async (req, res, next) => {
    const { bulkCreateSerialNumbers } = await import(
      "./routes/inventory/serial-numbers"
    );
  ...
  app.put("/api/inventory/serial-numbers/:id", async (req, res, next) => {
    const { updateSerialNumber } = await import(
      "./routes/inventory/serial-numbers"
    );
  ...
  app.delete("/api/inventory/serial-numbers/:id", async (req, res, next) => {
    const { deleteSerialNumber } = await import(
      "./routes/inventory/serial-numbers"
    );
  ...
  app.get("/api/inventory/stock-adjustments", async (req, res, next) => {
    const { getAllAdjustments } = await import(
  ...
  app.get(
    "/api/inventory/stock-adjustments/status/:status",
    async (req, res, next) => {
      const { getAdjustmentsByStatus } = await import(
        "./routes/inventory/stock-adjustments"
      );
  ...
  app.get(
    "/api/inventory/stock-adjustments/warehouse/:warehouseId",
    async (req, res, next) => {
      const { getAdjustmentsByWarehouse } = await import(
        "./routes/inventory/stock-adjustments"
      );
  ...
  app.get(
    "/api/inventory/stock-adjustments/pending/approvals",
    async (req, res, next) => {
      const { getPendingApprovals } = await import(
        "./routes/inventory/stock-adjustments"
      );
  ...
  app.get("/api/inventory/stock-adjustments/:id", async (req, res, next) => {
    const { getAdjustmentById } = await import(
      "./routes/inventory/stock-adjustments"
    );
  ...
  app.post("/api/inventory/stock-adjustments", async (req, res, next) => {
    const { createAdjustment } = await import(
      "./routes/inventory/stock-adjustments"
    );
  ...
  app.put("/api/inventory/stock-adjustments/:id", async (req, res, next) => {
    const { updateAdjustment } = await import(
      "./routes/inventory/stock-adjustments"
    );
  ...
  app.put(
    "/api/inventory/stock-adjustments/:id/submit",
    async (req, res, next) => {
  ...
  app.put(
    "/api/inventory/stock-adjustments/:id/approve",
    async (req, res, next) => {
      const { approveAdjustment } = await import(
        "./routes/inventory/stock-adjustments"
      );
  ...
  app.put(
    "/api/inventory/stock-adjustments/:id/reject",
    async (req, res, next) => {
      const { rejectAdjustment } = await import(
        "./routes/inventory/stock-adjustments"
      );
  ...
  app.delete("/api/inventory/stock-adjustments/:id", async (req, res, next) => {
    const { deleteAdjustment } = await import(
      "./routes/inventory/stock-adjustments"
    );
  ...
  app.get(
    "/api/inventory/stock-alerts/status/:status",
    async (req, res, next) => {
      const { getAlertsByStatus } = await import(
        "./routes/inventory/stock-alerts"
      );
  ...
  app.post("/api/inventory/stock-alerts/check", async (req, res, next) => {
    const { checkAndCreateAlerts } = await import(
      "./routes/inventory/stock-alerts"
    );
  ...
  app.put(
    "/api/inventory/stock-alerts/:id/acknowledge",
    async (req, res, next) => {
      const { acknowledgeAlert } = await import(
        "./routes/inventory/stock-alerts"
      );
  ...
  app.get("/api/inventory/expiry-notifications", async (req, res, next) => {
    const { getAllNotifications } = await import(
      "./routes/inventory/expiry-notifications"
    );
    return getAllNotifications(req, res, next);
  });

  app.get(
    "/api/inventory/expiry-notifications/active",
    async (req, res, next) => {
      const { getActiveNotifications } = await import(
        "./routes/inventory/expiry-notifications"
      );
  ...
  app.get(
    "/api/inventory/expiry-notifications/summary",
    async (req, res, next) => {
      const { getExpirySummary } = await import(
        "./routes/inventory/expiry-notifications"
      );
  ...
  app.get(
    "/api/inventory/expiry-notifications/critical",
    async (req, res, next) => {
      const { getCriticalExpiries } = await import(
        "./routes/inventory/expiry-notifications"
      );
  ...
  app.get(
    "/api/inventory/expiry-notifications/type/:type",
    async (req, res, next) => {
      const { getNotificationsByType } = await import(
        "./routes/inventory/expiry-notifications"
      );
  ...
  app.get(
    "/api/inventory/expiry-notifications/status/:status",
    async (req, res, next) => {
      const { getNotificationsByStatus } = await import(
        "./routes/inventory/expiry-notifications"
      );
  ...
  app.get("/api/inventory/expiry-notifications/:id", async (req, res, next) => {
    const { getNotificationById } = await import(
      "./routes/inventory/expiry-notifications"
    );
  ...
  app.post(
    "/api/inventory/expiry-notifications/check",
    async (req, res, next) => {
      const { checkAndCreateNotifications } = await import(
        "./routes/inventory/expiry-notifications"
      );
  ...
  app.put(
    ...
    async (req, res, next) => {
      const { acknowledgeNotification } = await import(
        "./routes/inventory/expiry-notifications"
      );
  ...
  app.put(
    "/api/inventory/expiry-notifications/:id/resolve",
    async (req, res, next) => {
  ...
  app.delete(
    "/api/inventory/expiry-notifications/:id",
    async (req, res, next) => {
  ...
  app.get("/api/inventory/analytics/overview", async (req, res, next) => {
    const { getInventoryOverview } = await import(
  ...
  app.get("/api/inventory/analytics/categories", async (req, res, next) => {
    const { getCategoryAnalysis } = await import(
      "./routes/inventory/analytics"
    );
  ...
  app.get("/api/inventory/analytics/warehouses", async (req, res, next) => {
    const { getWarehouseAnalysis } = await import(
      "./routes/inventory/analytics"
    );
  ...
  app.get("/api/inventory/analytics/performance", async (req, res, next) => {
    const { getProductPerformance } = await import(
      "./routes/inventory/analytics"
    );
  ...
  app.post("/api/inventory/transactions", async (req, res, next) => {
    const { createTransaction } = await import(
      "./routes/inventory/transaction-history"
    );
  ...
  app.get("/api/inventory/transactions/recent", async (req, res, next) => {
    const { getRecentTransactions } = await import(
      "./routes/inventory/transaction-history"
    );
  ...
  app.get("/api/inventory/transactions/summary", async (req, res, next) => {
    const { getTransactionSummary } = await import(
      "./routes/inventory/transaction-history"
    );
  ...
  app.get(
    ...
    async (req, res, next) => {
      const { getTransactionsByProduct } = await import(
        "./routes/inventory/transaction-history"
      );
  ...
  app.get(
    "/api/inventory/transactions/product/:productId/movement",
    async (req, res, next) => {
      const { getProductMovementHistory } = await import(
        "./routes/inventory/transaction-history"
      );
  ...
  app.get(
    "/api/inventory/transactions/warehouse/:warehouseId",
    async (req, res, next) => {
      const { getTransactionsByWarehouse } = await import(
        "./routes/inventory/transaction-history"
      );
  ...
  app.get("/api/inventory/transactions/type/:type", async (req, res, next) => {
    const { getTransactionsByType } = await import(
      "./routes/inventory/transaction-history"
    );
  ...
  app.get(
    "/api/inventory/transactions/user/:userId",
    async (req, res, next) => {
      const { getTransactionsByUser } = await import(
        "./routes/inventory/transaction-history"
      );
  ...
  app.get("/api/inventory/transactions/date-range", async (req, res, next) => {
    const { getTransactionsByDateRange } = await import(
      "./routes/inventory/transaction-history"
    );
  ...
  app.get(
    "/api/inventory/transactions/txn/:transactionId",
    async (req, res, next) => {
      const { getTransactionByTransactionId } = await import(
        "./routes/inventory/transaction-history"
      );
  ...
  app.put("/api/inventory/transactions/:id/cancel", async (req, res, next) => {
    const { cancelTransaction } = await import(
      "./routes/inventory/transaction-history"
    );
  ...
  app.post("/api/inventory/barcodes", async (req, res, next) => {
    const { createBarcodeMapping } = await import(
      "./routes/inventory/barcode-scanning"
    );
    return createBarcodeMapping(req, res, next);
  });

  app.post("/api/inventory/barcodes/bulk", async (req, res, next) => {
    const { bulkCreateBarcodes } = await import(
      "./routes/inventory/barcode-scanning"
    );
  ...
  app.get("/api/inventory/barcodes", async (req, res, next) => {
    const { getAllBarcodeMappings } = await import(
      "./routes/inventory/barcode-scanning"
    );
  ...
  app.get("/api/inventory/barcodes/stats", async (req, res, next) => {
    const { getBarcodeStats } = await import(
      "./routes/inventory/barcode-scanning"
    );
  ...
  app.get("/api/inventory/barcodes/search", async (req, res, next) => {
    const { searchBarcodes } = await import(
      "./routes/inventory/barcode-scanning"
    );
  ...
  app.get(
    "/api/inventory/barcodes/product/:productId",
    async (req, res, next) => {
      const { getBarcodesByProduct } = await import(
        "./routes/inventory/barcode-scanning"
      );
  ...
  app.post(
    "/api/inventory/barcodes/product/:productId/generate",
    async (req, res, next) => {
      const { generateProductBarcode } = await import(
        "./routes/inventory/barcode-scanning"
      );
  ...
  app.get("/api/inventory/barcodes/:barcode", async (req, res, next) => {
    const { getBarcodeMapping } = await import(
      "./routes/inventory/barcode-scanning"
    );
  ...
  app.put("/api/inventory/barcodes/:id", async (req, res, next) => {
    const { updateBarcodeMapping } = await import(
      "./routes/inventory/barcode-scanning"
    );
  ...
  app.delete("/api/inventory/barcodes/:id", async (req, res, next) => {
    const { deleteBarcodeMapping } = await import(
      "./routes/inventory/barcode-scanning"
    );
  ...
  app.post("/api/inventory/reports/expiry", async (req, res, next) => {
    const { generateExpiryReport } = await import(
      "./routes/inventory/reporting"
    );
  ...
  app.post("/api/inventory/reports/stock-alerts", async (req, res, next) => {
    const { generateStockAlertReport } = await import(
      "./routes/inventory/reporting"
    );
  ...
  app.post("/api/inventory/reports/warehouses", async (req, res, next) => {
    const { generateWarehouseReport } = await import(
      "./routes/inventory/reporting"
    );
  ...
  const { default: vendorRouter } = await import(
    "./routes/procurement/vendors"
  );
  const { default: priceRouter } = await import(
    "./routes/procurement/purchase-prices"
  );
  const { default: poRouter } = await import(
    "./routes/procurement/purchase-orders"
  );
  const { default: grRouter } = await import(
    "./routes/procurement/goods-receipts"
  );
  const { default: taxRateRouter } = await import("./routes/taxRatesRouter");
